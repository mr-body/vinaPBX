...
import {
  createAsteriskContact,
  updateAsteriskContact,
  deleteAsteriskContact,
  listAsteriskContacts,
} from "@/service/pjsip";
          ...
          >
            <div className="flex items-center gap-2">
              <span
                className={`inline-block w-2 h-2 rounded-full ${
                  contact.state === "online" ? "bg-green-500" : "bg-gray-400"
                }`}
              />
            ...
            <div className="flex gap-2">
              <button
                ...
                onClick={() => handleEditClick(contact.username)}
              >
                Editar
              </button>
              <button
                ...
                onClick={() => handleDelete(contact.username)}
              >
                Remover
              </button>
            </div>
